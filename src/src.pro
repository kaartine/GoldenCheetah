...
SOURCES += Train/WorkoutGame3DChunkBuilder.cpp Train/WorkoutGame3DCameraPresentation.cpp Train/WorkoutGame3DFeatureAsset.cpp Train/WorkoutGame3DGeometry.cpp Train/WorkoutGame3DHealth.cpp Train/WorkoutGame3DTerrainProfile.cpp Train/WorkoutGame3DViewModel.cpp Train/WorkoutGameForestComposition.cpp Train/WorkoutGameForestInstancing.cpp \
