...
SOURCES += Gui/AboutDialog.cpp Gui/AddIntervalDialog.cpp Gui/AnalysisSidebar.cpp Gui/ChooseCyclistDialog.cpp Gui/ColorButton.cpp \
           ...
           Gui/MergeActivityAlignment.cpp Gui/MergeActivityDistanceCursor.cpp Gui/MergeActivityRidePreparation.cpp Gui/MergeActivityWizard.cpp Gui/RideImportWizard.cpp Gui/SplitActivitySave.cpp Gui/SplitActivityWizard.cpp Gui/SplitRideData.cpp \
