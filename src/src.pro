...
HEADERS += Core/Athlete.h Core/ConfigFlags.h Core/Context.h Core/DataFilter.h Core/DataFilterResources.h Core/DataFilterSafety.h Core/DataFilterZones.h Core/FreeSearch.h Core/GcCalendarModel.h Core/GcUpgrade.h \
           Core/IdleTimer.h Core/IntervalItem.h Core/LinkedActivityRemovalJournal.h Core/NamedSearch.h Core/RideCache.h Core/RideCacheBackgroundSaver.h Core/RideCacheBulkMerge.h Core/RideCacheCallbackGuard.h Core/RideCachePersistence.h Core/RideCacheSaveCapture.h Core/RideCacheSaveSnapshot.h Core/RideCacheSnapshot.h Core/RideCacheStartup.h Core/RideCacheModel.h Core/RideDB.h \
...
SOURCES += Core/Athlete.cpp Core/Context.cpp Core/DataFilter.cpp Core/DataFilterSafety.cpp Core/DataFilterZones.cpp Core/FreeSearch.cpp Core/GcUpgrade.cpp Core/IdleTimer.cpp \
           Core/IntervalItem.cpp Core/LinkedActivityRemovalJournal.cpp Core/main.cpp Core/NamedSearch.cpp Core/RideCache.cpp Core/RideCacheBackgroundSaver.cpp Core/RideCachePersistence.cpp Core/RideCacheSaveCapture.cpp Core/RideCacheSaveSnapshot.cpp Core/RideCacheSnapshot.cpp Core/RideCacheRemoval.cpp Core/RideCacheModel.cpp Core/RideItem.cpp \
...
SOURCES += FileIO/ArchiveFile.cpp FileIO/AthleteBackup.cpp FileIO/AthleteBackupArchive.cpp FileIO/Bin2RideFile.cpp FileIO/BinRideFile.cpp FileIO/CompressedActivityFile.cpp FileIO/CpCsvImport.cpp \
           FileIO/CommPort.cpp \
