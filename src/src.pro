...
# always
QT += xml sql network svg widgets quick concurrent serialport multimedia multimediawidgets \
...
SOURCES += Train/AddDeviceWizard.cpp Train/CalibrationData.cpp Train/ComputrainerController.cpp Train/Computrainer.cpp Train/DeviceConfiguration.cpp \
           ...
           Train/VideoSyncFileBase.cpp Train/ErgFileBase.cpp Train/TrainingCommandRouter.cpp Train/TrainingCsvSeries.cpp Train/TrainerTargetCoordinator.cpp Train/VirtualDrivetrain.cpp Train/WorkoutGameCanvas.cpp Train/WorkoutGameCompetition.cpp Train/WorkoutGameCourse.cpp Train/WorkoutGameCourseConversion.cpp Train/WorkoutGameCourseConversionDialog.cpp Train/WorkoutGameCourseCrsExporter.cpp Train/WorkoutGameCourseDocument.cpp Train/WorkoutGameCoursePreviewWidget.cpp Train/WorkoutGameCourseRuntime.cpp Train/WorkoutGameCourseSourceAdapter.cpp Train/WorkoutGameDistanceCourse.cpp Train/WorkoutGameDistancePlayback.cpp Train/WorkoutGameFeatureChallenge.cpp Train/WorkoutGameFeatureLab.cpp Train/WorkoutGameFeatureRuntime.cpp Train/WorkoutGameOpenGLCanvas.cpp Train/WorkoutGameRendererPolicy.cpp Train/WorkoutGameRoadCourse.cpp Train/WorkoutGameRoadPhysics.cpp Train/WorkoutGameRoadProjection.cpp Train/WorkoutGameSceneGraphWindow.cpp Train/WorkoutGameSessionState.cpp Train/WorkoutGameSimulation.cpp Train/WorkoutGameTerrainTransition.cpp Train/WorkoutGameTrailScene.cpp Train/WorkoutGameVisualSmoother.cpp Train/WorkoutGameWindow.cpp Train/WorkoutGameWorkoutAdapter.cpp Train/WorkoutGameWorld.cpp Train/WorkoutRideCommandFilter.cpp Train/WorkoutRideTargetPlanner.cpp \
