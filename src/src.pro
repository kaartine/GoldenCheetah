...
HEADERS += Core/Athlete.h Core/ConfigFlags.h Core/Context.h Core/DataFilter.h Core/DataFilterResources.h Core/DataFilterSafety.h Core/DataFilterZones.h Core/FreeSearch.h Core/GcCalendarModel.h Core/GcUpgrade.h \
           Core/IdleTimer.h Core/IntervalItem.h Core/NamedSearch.h Core/RideCache.h Core/RideCacheBackgroundSaver.h Core/RideCacheBulkMerge.h Core/RideCachePersistence.h Core/RideCacheSaveCapture.h Core/RideCacheSaveSnapshot.h Core/RideCacheSnapshot.h Core/RideCacheStartup.h Core/RideCacheModel.h Core/RideDB.h \
...
HEADERS += Gui/AboutDialog.h Gui/AddIntervalDialog.h Gui/AnalysisSidebar.h Gui/CacheWriteWarning.h Gui/ChooseCyclistDialog.h Gui/ColorButton.h \
           ...
           Gui/MergeActivityAlignment.h Gui/MergeActivityDistanceCursor.h Gui/MergeActivityRidePreparation.h Gui/MergeActivityTimeOffset.h Gui/MergeActivityWizard.h Gui/MergeActivityXData.h Gui/RideImportRideStore.h Gui/RideImportWizard.h Gui/SplitActivitySave.h Gui/SplitActivityWizard.h Gui/SplitRideData.h \
...
SOURCES += Core/Athlete.cpp Core/Context.cpp Core/DataFilter.cpp Core/DataFilterSafety.cpp Core/DataFilterZones.cpp Core/FreeSearch.cpp Core/GcUpgrade.cpp Core/IdleTimer.cpp \
           Core/IntervalItem.cpp Core/main.cpp Core/NamedSearch.cpp Core/RideCache.cpp Core/RideCacheBackgroundSaver.cpp Core/RideCachePersistence.cpp Core/RideCacheSaveCapture.cpp Core/RideCacheSaveSnapshot.cpp Core/RideCacheSnapshot.cpp Core/RideCacheRemoval.cpp Core/RideCacheModel.cpp Core/RideItem.cpp \
