...
# always
QT += xml sql network svg widgets quick quick3d concurrent serialport multimedia multimediawidgets \
...
contains(DEFINES, "GC_WANT_PYTHON") {
    ...
    HEADERS += Python/PythonEmbed.h Python/PythonExecutionGate.h \
               ...
               Python/PythonRuntimePostInitializer.h \
...
SOURCES += Cloud/OpenDataCaptureUtils.cpp
HEADERS += Cloud/OpenDataCaptureUtils.h
SOURCES += Cloud/OpenDataCaptureStateMachine.cpp
HEADERS += Cloud/OpenDataCaptureStateMachine.h
SOURCES += Cloud/OpenDataExport.cpp
HEADERS += Cloud/OpenDataExport.h
SOURCES += Cloud/OpenDataSummaryStatistics.cpp
HEADERS += Cloud/OpenDataSummaryStatistics.h
SOURCES += Cloud/OpenDataTransport.cpp
HEADERS += Cloud/OpenDataTransport.h
SOURCES += Cloud/OpenDataTemporaryArchive.cpp
HEADERS += Cloud/OpenDataTemporaryArchive.h
SOURCES += Cloud/OpenDataUploadWorker.cpp
HEADERS += Cloud/OpenDataUploadWorker.h
...
HEADERS += Cloud/StravaAccountRemoval.h
SOURCES += Cloud/StravaApiReplyPolicy.cpp
HEADERS += Cloud/StravaApiReplyPolicy.h
SOURCES += Cloud/StravaActivityDescription.cpp
HEADERS += Cloud/StravaActivityDescription.h
SOURCES += Cloud/StravaTokenRefresh.cpp
HEADERS += Cloud/StravaTokenRefresh.h
SOURCES += Cloud/StravaTokenPublication.cpp
...
HEADERS += Cloud/OAuthCallbackPolicy.h
...
QT += charts opengl openglwidgets
...
# core data
HEADERS += Core/Athlete.h Core/AthleteRefreshLifecycle.h Core/AthleteSession.h Core/ConfigFlags.h Core/Context.h Core/DataFilter.h Core/DataFilterResources.h Core/DataFilterSafety.h Core/DataFilterZones.h Core/FreeSearch.h Core/GcCalendarModel.h Core/GcUpgrade.h Core/RideRefreshCacheInputs.h Core/RideRefreshEnvironment.h Core/RideRefreshItemInputs.h Core/RideRefreshMeasures.h Core/RideRefreshRoutes.h Core/RideRefreshTargetRegistry.h Core/RideRefreshZones.h \
           Core/IdleTimer.h Core/IntervalItem.h Core/LinkedActivityRemovalJournal.h Core/LinkedActivitySaveJournal.h Core/NamedSearch.h Core/PlannedActivityFileStager.h Core/RideCache.h Core/RideCacheBackgroundSaver.h Core/RideCacheBulkMerge.h Core/RideCacheCallbackGuard.h Core/RideCacheMutationScope.h Core/RideCachePersistence.h Core/RideCacheSaveCapture.h Core/RideCacheSaveSnapshot.h Core/RideCacheSnapshot.h Core/RideCacheStartup.h Core/RideItemRefreshResult.h Core/RideCacheModel.h Core/RideDB.h \
...
HEADERS += FileIO/AnchoredFileSystem.h FileIO/ArchiveFile.h FileIO/AtomicFileWriter.h FileIO/AthleteBackup.h FileIO/AthleteBackupArchive.h FileIO/Bin2RideFile.h FileIO/BinRideFile.h FileIO/CompressedActivityFile.h FileIO/CpCsvImport.h \
           FileIO/CommPort.h \
           ...
           FileIO/RideFileCommand.h FileIO/RideFileCRC.h FileIO/RideFileDerivedSeriesInputs.h FileIO/RideFilePostProcessInputs.h FileIO/RideFileTemporaryWorkspace.h FileIO/RideFile.h FileIO/RideFileTableModel.h  FileIO/Serial.h \
...
HEADERS += Gui/AboutDialog.h Gui/AddIntervalDialog.h Gui/AnalysisSidebar.h Gui/CacheWriteWarning.h Gui/ChooseCyclistDialog.h Gui/ColorButton.h \
           ...
           Gui/MergeActivityAlignment.h Gui/MergeActivityDistanceCursor.h Gui/MergeActivityRidePreparation.h Gui/MergeActivityTimeOffset.h Gui/MergeActivityWizard.h Gui/MergeActivityXData.h Gui/RideImportRideStore.h Gui/RideImportWizard.h Gui/SplitActivitySave.h Gui/SplitActivityWorkflow.h Gui/SplitActivityWizard.h Gui/SplitRideData.h \
...
HEADERS += Train/AddDeviceWizard.h Train/CalibrationData.h Train/ComputrainerController.h Train/Computrainer.h Train/DeviceConfiguration.h \
           ...
           Train/TrainingCommandRouter.h Train/TrainingCsvSeries.h Train/TrainingRecordingIo.h Train/TrainingTelemetryTimeline.h Train/TrainerTargetCoordinator.h Train/VirtualDrivetrain.h Train/WorkoutGameAudio.h Train/WorkoutGameAudioEvents.h Train/WorkoutGameCanvas.h Train/WorkoutGameChallengeGeometry.h Train/WorkoutGameClock.h Train/WorkoutGameCompetition.h Train/WorkoutGameCourse.h Train/WorkoutGameCourseConversion.h Train/WorkoutGameCourseConversionDialog.h Train/WorkoutGameCourseCrsExporter.h Train/WorkoutGameCourseDocument.h Train/WorkoutGameCoursePreviewMetrics.h Train/WorkoutGameCoursePreviewWidget.h Train/WorkoutGameCourseRuntime.h Train/WorkoutGameCourseSourceAdapter.h Train/WorkoutGameDiagnostics.h Train/WorkoutGameDistanceCourse.h Train/WorkoutGameDistancePlayback.h Train/WorkoutGameEngine.h Train/WorkoutGameFeatureCatalog.h Train/WorkoutGameFeatureChallenge.h Train/WorkoutGameFeatureGeometry.h Train/WorkoutGameFeatureHud.h Train/WorkoutGameFeatureLab.h Train/WorkoutGameFeatureRuntime.h Train/WorkoutGameForestFloor.h Train/WorkoutGameMesh.h Train/WorkoutGameOcclusion.h Train/WorkoutGameOpenGLCanvas.h Train/WorkoutGamePowerCueGeometry.h Train/WorkoutGamePowerProfile.h Train/WorkoutGameRendererPolicy.h Train/WorkoutGameReplay.h Train/WorkoutGameRoadCourse.h Train/WorkoutGameRoadPlan.h Train/WorkoutGameRoadQuality.h Train/WorkoutGameRoadPhysics.h Train/WorkoutGameRoadProjection.h Train/WorkoutGameRunner.h Train/WorkoutGameSceneGraphWindow.h Train/WorkoutGameSessionState.h Train/WorkoutGameSimulation.h Train/WorkoutGameTerrainTransition.h Train/WorkoutGameTrailBranch.h Train/WorkoutGameTrailScene.h Train/WorkoutGameTrailTile.h Train/WorkoutGameTrainerTargetPlanner.h Train/WorkoutGameVisualSmoother.h Train/WorkoutGameWindow.h Train/WorkoutGameWorkoutAdapter.h Train/WorkoutGameWorld.h Train/WorkoutRideCommandFilter.h Train/WorkoutRideTargetPlanner.h \
           Train/WorkoutGameWorkoutIdentity.h \
           Train/DialWindow.h \
           Train/TrainerDayDownloadDialog.h Train/TrainerDay.h Train/ErgFile.h Train/ErgFilePlot.h Train/WorkoutFileWriter.h \
           Train/Library.h Train/LibraryParser.h Train/MeterWidget.h Train/NullController.h Train/RealtimeController.h Train/TrainingDataGenerator.h Train/TrainingDataGeneratorTargetRouting.h Train/TrainingDeviceWizardRouting.h \
...
SOURCES += Core/Athlete.cpp Core/AthleteRefreshLifecycle.cpp Core/AthleteSession.cpp Core/Context.cpp Core/ContextSessionServices.cpp Core/DataFilter.cpp Core/DataFilterSafety.cpp Core/DataFilterZones.cpp Core/FreeSearch.cpp Core/GcUpgrade.cpp Core/IdleTimer.cpp Core/RideRefreshCacheInputs.cpp Core/RideRefreshEnvironment.cpp Core/RideRefreshEnvironmentCapture.cpp Core/RideRefreshMeasures.cpp Core/RideRefreshMeasuresCapture.cpp Core/RideRefreshMeasuresAssembly.cpp Core/RideRefreshMeasuresAthleteCapture.cpp Core/RideRefreshRoutes.cpp Core/RideRefreshRoutesAssembly.cpp Core/RideRefreshRoutesCapture.cpp Core/RideRefreshZones.cpp Core/RideRefreshZonesCapture.cpp Core/RideRefreshZonesAssembly.cpp Core/RideRefreshZonesAthleteCapture.cpp \
           Core/IntervalItem.cpp Core/LinkedActivityRemovalJournal.cpp Core/LinkedActivitySaveJournal.cpp Core/main.cpp Core/NamedSearch.cpp Core/PlannedActivityFileFactoryStager.cpp Core/PlannedActivityFileStager.cpp Core/RideCache.cpp Core/RideCacheActivityLinking.cpp Core/RideCacheActivitySave.cpp Core/RideCacheBackgroundSaver.cpp Core/RideCacheCalendarMutations.cpp Core/RideCacheGarbageCollection.cpp Core/RideCacheImport.cpp Core/RideCacheLiveView.cpp Core/RideCacheMutationScope.cpp Core/RideCachePersistence.cpp Core/RideCacheSaveCapture.cpp Core/RideCacheSaveSnapshot.cpp Core/RideCacheSnapshot.cpp Core/RideCacheRemoval.cpp Core/RideCacheModel.cpp Core/RideCacheModelProtocol.cpp Core/RideItem.cpp \
...
SOURCES += FileIO/AnchoredFileSystem.cpp FileIO/ArchiveFile.cpp FileIO/AthleteBackup.cpp FileIO/AthleteBackupArchive.cpp FileIO/Bin2RideFile.cpp FileIO/BinRideFile.cpp FileIO/CompressedActivityFile.cpp FileIO/CpCsvImport.cpp \
           FileIO/CommPort.cpp \
           FileIO/Computrainer3dpFile.cpp FileIO/CsvRideFile.cpp FileIO/DataProcessor.cpp FileIO/Device.cpp \
           FileIO/FitFileIntegrity.cpp FileIO/FitlogParser.cpp FileIO/FitlogRideFile.cpp FileIO/FitRideFile.cpp FileIO/FixAeroPod.cpp FileIO/FixDeriveDistance.cpp \
           ...
           FileIO/RideFileCommand.cpp FileIO/RideFileCRC.cpp FileIO/RideFileTemporaryWorkspace.cpp FileIO/RideFile.cpp FileIO/RideFileTableModel.cpp \
...
SOURCES += Train/WorkoutGameWorkoutIdentity.cpp \
           Train/AddDeviceWizard.cpp Train/CalibrationData.cpp Train/ComputrainerController.cpp Train/Computrainer.cpp Train/DeviceConfiguration.cpp \
           Train/DeviceTypes.cpp Train/DialWindow.cpp Train/TrainerDay.cpp Train/TrainerDayDownloadDialog.cpp Train/ErgFile.cpp Train/ErgFileBytes.cpp Train/ErgFilePlot.cpp Train/WorkoutFileWriter.cpp \
           Train/Library.cpp Train/LibraryImportFileStager.cpp Train/WorkoutImportBatch.cpp Train/WebDownloadImportPolicy.cpp Train/LibraryParser.cpp Train/MeterWidget.cpp Train/NullController.cpp Train/RealtimeController.cpp Train/TrainingDataGenerator.cpp Train/TrainingDataGeneratorTargetRouting.cpp \
           ...
           Train/VideoSyncFileBase.cpp Train/ErgFileBase.cpp Train/TrainingCommandRouter.cpp Train/TrainingCsvSeries.cpp Train/TrainerTargetCoordinator.cpp Train/VirtualDrivetrain.cpp Train/WorkoutGameAudio.cpp Train/WorkoutGameAudioEvents.cpp Train/WorkoutGameCanvas.cpp Train/WorkoutGameClock.cpp Train/WorkoutGameCompetition.cpp Train/WorkoutGameCourse.cpp Train/WorkoutGameCourseConversion.cpp Train/WorkoutGameCourseConversionDialog.cpp Train/WorkoutGameCourseCrsExporter.cpp Train/WorkoutGameCourseDocument.cpp Train/WorkoutGameCoursePreviewMetrics.cpp Train/WorkoutGameCoursePreviewWidget.cpp Train/WorkoutGameCourseRuntime.cpp Train/WorkoutGameCourseSourceAdapter.cpp Train/WorkoutGameDiagnostics.cpp Train/WorkoutGameDistanceCourse.cpp Train/WorkoutGameDistancePlayback.cpp Train/WorkoutGameEngine.cpp Train/WorkoutGameFeatureChallenge.cpp Train/WorkoutGameFeatureHud.cpp Train/WorkoutGameFeatureLab.cpp Train/WorkoutGameFeatureRuntime.cpp Train/WorkoutGameGapJumpGeometry.cpp Train/WorkoutGameGapJumpLaunchWindow.cpp Train/WorkoutGameGapJumpSelector.cpp Train/WorkoutGameHorizon.cpp Train/WorkoutGameMesh.cpp Train/WorkoutGameOpenGLCanvas.cpp Train/WorkoutGamePositionRate.cpp Train/WorkoutGamePowerCueGeometry.cpp Train/WorkoutGamePowerProfile.cpp Train/WorkoutGameRendererPolicy.cpp Train/WorkoutGameReplay.cpp Train/WorkoutGameRoadCourse.cpp Train/WorkoutGameRoadPlan.cpp Train/WorkoutGameRoadQuality.cpp Train/WorkoutGameRoadPhysics.cpp Train/WorkoutGameRoadProjection.cpp Train/WorkoutGameRunner.cpp Train/WorkoutGameSceneGraphWindow.cpp Train/WorkoutGameSessionState.cpp Train/WorkoutGameSimulation.cpp Train/WorkoutGameTerrainTransition.cpp Train/WorkoutGameTrailScene.cpp Train/WorkoutGameTrailTile.cpp Train/WorkoutGameTrainerTargetPlanner.cpp Train/WorkoutGameVisualSmoother.cpp Train/WorkoutGameWindow.cpp Train/WorkoutGameWorkoutAdapter.cpp Train/WorkoutGameWorld.cpp Train/WorkoutRideCommandFilter.cpp Train/WorkoutRideTargetPlanner.cpp \
...
HEADERS += Train/WorkoutGame3DChunkBuilder.h Train/WorkoutGame3DCameraComfort.h Train/WorkoutGame3DCameraPresentation.h Train/WorkoutGame3DFeatureAsset.h Train/WorkoutGame3DGeometry.h Train/WorkoutGame3DHealth.h Train/WorkoutGame3DTerrainProfile.h Train/WorkoutGame3DViewModel.h Train/WorkoutGameForestComposition.h Train/WorkoutGameForestInstancing.h \
           Train/WorkoutGame3DWindow.h
SOURCES += Train/WorkoutGame3DChunkBuilder.cpp Train/WorkoutGame3DCameraComfort.cpp Train/WorkoutGame3DCameraPresentation.cpp Train/WorkoutGame3DFeatureAsset.cpp Train/WorkoutGame3DGeometry.cpp Train/WorkoutGame3DHealth.cpp Train/WorkoutGame3DTerrainProfile.cpp Train/WorkoutGame3DViewModel.cpp Train/WorkoutGameForestComposition.cpp Train/WorkoutGameForestInstancing.cpp \
