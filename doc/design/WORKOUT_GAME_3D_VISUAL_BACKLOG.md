...
| VIS-05 | P0 | open | Long sections remain too straight and visually calm for an MTB trail. | The review route contains smooth gentle, medium and near-90-degree turns, ordinary banked bends, rollers, short rises and descents with no abrupt camera yaw. |
