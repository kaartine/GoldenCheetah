...
private slots:
    ...
    void rejectedPostResetPreparationLeavesMergeUntouched();
...
void TestRideImportBatch::rejectedPostResetPreparationLeavesMergeUntouched()
{
    const QDateTime base(
        QDate(2020, 1, 1), QTime(0, 0), QTimeZone::UTC);
    MergeItem *existing = item(QStringLiteral("existing"), base, 1);
