...
private slots:
    ...
    void gapSectionReservesStraightApproachForAuthoredBranch()
    {
        ...
        course.seed = 2u;
        course.durationMs = 30000;
        WorkoutGameSection gap;
        gap.feature = WorkoutGameFeature::SprintJump;
        gap.terrain = WorkoutGameTerrainKind::GapJump;
        gap.durationMs = course.durationMs;
        gap.lengthMeters = 100.0;
        gap.targetWatts = 200.0;
        gap.difficulty = 0.5;
        gap.challengeCount = 1;
        course.sections = {gap};
